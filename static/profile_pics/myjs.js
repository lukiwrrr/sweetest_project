                                        ...
                                        <nav class="level is-mobile">
                                            <div class="level-left">
                                                <a class="level-item is-sparta" aria-label="heart" onclick="toggle_like('${post["_id"]}', 'heart')">
                                                    <span class="icon is-small"><i class="fa ${class_heart}" style="color: #ff3333;"
                                                ...
                                                <a class="level-item is-sparta" aria-label="star" onclick="toggle_star('${post["_id"]}', 'star')">
                                                    <span class="icon is-small"><i class="fa ${class_star}" style="color: #ff3333;"
                                                ...
                                                <a class="level-item is-sparta" aria-label="thumbsup" onclick="toggle_thumbsup('${post["_id"]}', 'thumbsup')">
                                                    <span class="icon is-small"><i class="fa ${class_thumbsup}" style="color: #ff3333;"
...
//     if (postBox.length === 0) {
//         console.error("Element #post-box tidak jumpa");
//         return;
//     }
